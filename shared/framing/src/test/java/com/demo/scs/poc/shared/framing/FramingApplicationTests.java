...
public class FramingApplicationTests extends AbstractRestTemplateOAuthTest {
    ...
    public void resourceLoads() throws Exception {
        ResponseEntity<String> response = template.getForEntity("http://localhost:{port}/v1/index.html", String.class, port);
