...
public class ConnectUiApplicationTests extends AbstractRestTemplateOAuthTest {
    ...
    public void beatById() {
        ResponseEntity<String> response = template.getForEntity("http://localhost:" + port + BEAT_PATH + "?id=connect:1", String.class);
        assertEquals(HttpStatus.OK, response.getStatusCode());
